...
from app.schemas import ScheduleCreate, Schedule as ScheduleSchema
...
class ScheduleService:
    ...
    async def create_schedule(self, schedule_data: ScheduleCreate) -> ScheduleSchema:
        ...
        return ScheduleSchema.model_validate(db_schedule, from_attributes=True)
    ...
    async def list_schedules(self) -> List[ScheduleSchema]:
        ...
        return [ScheduleSchema.model_validate(s, from_attributes=True) for s in schedules]
